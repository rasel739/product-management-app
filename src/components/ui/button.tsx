...
const Button = ({
  ...
  const variants = {
    primary: 'bg-accent-green text-white hover:bg-accent-green/90 focus:ring-accent-green',
    ...
    outline:
      'border-2 border-accent-green text-accent-green hover:bg-accent-green hover:text-white focus:ring-accent-green',
  };
